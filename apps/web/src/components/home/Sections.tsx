...
export function ServicesSection() {
  const services = [
    ...
    },
    {
      ...
      image: '/assets/images/album/album-harness-rail.jpg',
      alt: '행복한요양원 재활 케어 모습',
      icon: '♿',
    },
    {
    ...
    },
    {
      ...
      image: '/assets/images/album/album-cognition-1to1.jpg',
      alt: '요양원 프로그램 활동 모습',
      icon: '🎨',
    },
    {
      ...
      image: '/assets/images/album/album-meal-care.jpg',
      alt: '요양원 식사와 식단',
      icon: '🍚',
    },
    {
  ...
  const differentiators = [
    {
      id: 1,
      icon: '🚶‍♂️',
      title: '양주요양원 · 의정부요양원 이지스텝 보행 재활',
      description: '양주요양원과 의정부요양원 중에서도 드물게 갖춘 이지스텝 하네스 레일 보행 재활 시스템으로 안전한 보행 훈련과 하지 근력 강화를 돕습니다. 녹양역 인근 요양원으로 어르신의 신체 기능 유지에 실질적인 도움을 드립니다.',
      color: 'orange',
    },
    {
      id: 2,
      icon: '🏢',
      title: '양주 지하 1층~4층 단독 건물 운영',
      description: '의정부요양원과 양주요양원을 찾는 보호자분들께 적합한 지하 1층~4층 단독 건물 요양원입니다. 녹양역 1번 출구 도보 10분 거리로 접근성이 뛰어나며, 보호자님의 방문이 편리합니다.',
      color: 'brown',
    },
    {
      id: 3,
      icon: '🛏️',
      title: '양주요양원 1·2·4인실 맞춤 생활 공간',
      description: '의정부요양원 및 양주요양원 중에서도 다양한 생활실 구성을 갖춘 시설로, 어르신의 생활 패턴과 선호에 맞춰 선택할 수 있는 생활실을 갖추었습니다. 밝고 깨끗한 환경에서 편안하게 지내실 수 있도록 정성껏 관리합니다.',
      color: 'green',
    },
    {
      id: 4,
      icon: '🤝',
      title: '의정부요양원 A등급 자매시설 운영 노하우',
