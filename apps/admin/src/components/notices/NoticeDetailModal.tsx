import { X, ExternalLink, Link2, MessageCircle, Pencil, Pin } from 'lucide-react'
import { NOTICE_LEVEL, type InternalNotice } from '@/api/noticeClient'
...
export default function NoticeDetailModal({
  ...
  const share = async () => {
    try { await shareNotice({ title: n.title, content: n.content, level: n.level, link: publicUrl }) }
